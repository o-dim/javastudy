...
public class MainClass {
	...
	public static void q4() {
		...
		System.out.println(begin + "부터 " + end + "사이 모든 정수의 평균은 " + (double) total / (z * 2) + "입니다.");
	...
	public static void q8() {
		...
		switch (score / 10) {
			case 9 : System.out.print("냄비");
			case 8 : System.out.print("식칼");
			case 7 : System.out.print("도마");
	...
	public static void q10() {
		...
		System.out.println("가장 높은 점수를 받은 사람은 " + names[z] + "입니다.");
